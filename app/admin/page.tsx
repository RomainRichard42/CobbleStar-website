...
export default function AdminDashboard() {
  ...
  return <main className={styles.page} id="contenu">
    <header className={styles.topbar}>
      ...
      <nav><Link href="/admin/joueurs/">Joueurs en jeu</Link><Link href="/admin/creation/">Quêtes & PNJ</Link><Link href="/admin/arenes/">Arènes & Ligue</Link><Link href="/compte/">Mon compte</Link><Link href="/wiki/admin/">Studio wiki</Link><button onClick={() => void load()} disabled={loading}>{loading ? "Actualisation…" : "Actualiser ↻"}</button></nav>
    </header>

    ...
    <main>
      ...
      <div className="legal-content">
        ...
        <section id="donnees">
          ...
          <p>Après liaison, ton UUID Minecraft identifie ton profil et Discord reste ton moyen de connexion. Si tu demandes une nouvelle liaison, un journal technique conserve les identifiants concernés, la date et les données regroupées pour retracer cette opération. L’e-mail n’est pas utilisé pour récupérer un profil Minecraft.</p>

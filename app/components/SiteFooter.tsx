...
export default function SiteFooter() {
  return (
    <footer>
      ...
      <div><Link href="/boutique/">Boutique</Link><Link href="/vote/">Votes</Link><Link href="/compte/">Compte</Link><a href="https://github.com/RomainRichard42/CobbleStar-launcher">GitHub</a></div>
